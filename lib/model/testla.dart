...
//
//     final testla = testlaFromJson(jsonString);

import 'dart:convert';

Testla testlaFromJson(String str) => Testla.fromJson(json.decode(str));

String testlaToJson(Testla data) => json.encode(data.toJson());
...
class Testla {
  ...
  factory Testla.fromJson(Map<String, dynamic> json) => Testla(
